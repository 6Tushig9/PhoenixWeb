...
<footer>
    <div class="FooterCont">
        ...
        <div class="fcontact">
            ...
            <div class="utas">+976-8939-0000 </div>
            <div class="hayg" id="Ohayg"> Оффис:&ensp; Улаанбаатар хот, Амарсанаагын гудамж, Гандан 16р хороо, Колорадо бизнес төв, 202 тоот</div>
            <div class="hayg" id="bbhayg"> Борлуулалтын байр:&ensp; Улаанбаатар хот, Аюушийн өргөн чөлөө, БГД 8р хороо, Хороолол барилгын материалын дэлгүүр, В1 давхар</div>
            <div class="hayg" id="Uhayg"> Үйлдвэр:&ensp; Улаанбаатар хот, БЗД 29р хороо, Зохицол төсөл</div>
        </div>
        <div class="fsocial">
    ...
    <div class="endcrdt">
        <div class="fline"></div>
        <div class="endtext">@ 2024 | Designed by SprouX</div>
    </div>
</footer>