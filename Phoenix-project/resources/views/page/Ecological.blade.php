...
<div class="SocialCont">
  ...
  <div class="hayg" id="Ohayg">
    Оффис: Улаанбаатар хот, Амарсанаагын гудамж, Гандан 16р хороо, Колорадо
    бизнес төв, 202 тоот
  </div>
  <div class="hayg" id="bbhayg">
    Борлуулалтын байр: Улаанбаатар хот, Аюушийн өргөн чөлөө, БГД 8р хороо,
    Хороолол барилгын материалын дэлгүүр, В1 давхар
  </div>
  <div class="hayg" id="Uhayg">
    Үйлдвэр: Улаанбаатар хот, БЗД 29р хороо, Зохицол төсөл
  </div>
